...
public class ConfigVMCActivity extends BaseActivity {
    ...
    public void onCreate(Bundle bundle) {
        setContentView(R.layout.activity_config_vmcactivity);
        this.activity = this;
        this.typeActStyle = 3;
            ...
            if (i == 1) {
                ...
                connectToWifi(new Runnable() {
                    public void run() {
                        new Thread(new Runnable() {
                            public void run() {
                                if (!ConfigVMCActivity.this.check_invioRicetta()) {
                                    ConfigVMCActivity.this.error();
                                    return;
                                }
                                try {
                                    Thread.sleep(500);
                                ...
                                configMasterOnline.setName(ConfigVMCActivity.this.name);
                                configMasterOnline.setPin(ConfigVMCActivity.this.pin);
                                ...
                                if (Constants.token == null || Constants.token == "") {
                                    ConfigVMCActivity.this.token = Constants.FIX_TOKEN;
                                } else {
                                    ConfigVMCActivity.this.token = Functions.calcNewToken(ConfigVMCActivity.this.pref, ConfigVMCActivity.this.getResources());
                                }
                                configMasterOnline.setApi_token(ConfigVMCActivity.this.token);
                                configMasterOnline.setApi_user(Constants.user);
                                String str = null;
                                for (int i = 0; i < 5; i++) {
                                    if (ConfigVMCActivity.this.getCurretWifiName().replace("\"", "").equals(BaseActivity.toConnSid)) {
                                        UDPSocket.startListening(true);
                                        str = UDPSocket.sendCMD(configMasterOnline, 15000, (long) ConfigVMCActivity.this.akwait);
                                        ...
                                        ConfigVMCActivity.this.connectToWifi(r3, false, true);
                                        try {
                                            Thread.sleep(10000);
                                ...
                                ConfigVMCActivity.this.hideProgress();
                                if (str == null) {
                                    ConfigVMCActivity.this.error();
                                    return;
                                }
                                try {
                                    ...
                                    if (jSONObject.getInt(Constants.JSON_RES) != 1) {
                                        ...
                                        ConfigVMCActivity.this.serialToCheck = jSONObject.getString("ser");
                                        ConfigVMCActivity.this.CheckInfoVMC(100, 0, 0, 300000);
                                    }
                ...
                connectToWifi(new Runnable() {
                    public void run() {
                        new Thread(new Runnable() {
                            public void run() {
                                boolean unused = ConfigVMCActivity.this.check_invioRicetta();
                                CmdPICO.ConfigMasterOffline configMasterOffline = new CmdPICO.ConfigMasterOffline();
                                configMasterOffline.setConfig_mod(1);
                                configMasterOffline.setName(ConfigVMCActivity.this.name);
                                configMasterOffline.setPin(ConfigVMCActivity.this.pin);
                                UDPSocket.startListening();
                                String sendCMD = UDPSocket.sendCMD(configMasterOffline, (long) ConfigVMCActivity.this.akwait, (long) ConfigVMCActivity.this.akwait);
                                if (sendCMD == null) {
                                    ConfigVMCActivity.this.error();
                                }
                                try {
                                    ...
                                    if (jSONObject.getInt(Constants.JSON_RES) == 1) {
                                        ...
                                        if (string == null || string.isEmpty()) {
                                            ...
                                            boolean unused2 = ConfigVMCActivity.this.setVMCWiFiMode(1);
                                            ConfigVMCActivity.this.disconnectFromWIfi();
                                            ConfigVMCActivity.this.addVMC(string, true);
                                        }
                                    } else {
                                        ConfigVMCActivity.this.error();
                                    }
    ...
    public boolean check_invioRicetta() {
        try {
            JSONObject fw = getFw();
            ...
            for (int i = 0; i < Constants.MODBUSRECEPIES.size() && this.RICETTA == null; i++) {
                if (Constants.MODBUSRECEPIES.get(i).getPRAN_Id() == 1) {
    ...
    public void CheckInfoVMC(int r21, int r22, int r23, long r24) {
        /*
            r20 = this;
            r0 = r20
        ...
        L_0x008b:
            r10 = r21
            it.tecnosystemi.TS.Activity.VMC.Config.ConfigVMCActivity$3 r11 = new it.tecnosystemi.TS.Activity.VMC.Config.ConfigVMCActivity$3
            r11.<init>()
        ...
        L_0x00b0:
            ...
            r1 = 2
            r0.setVMCWiFiMode(r1)     // Catch:{ Exception -> 0x00ce }
        ...
        L_0x00c3:
            ...
            r20.checkVMCOnline()     // Catch:{ Exception -> 0x00ce }
            goto L_0x0133
        L_0x00ce:
            r20.error()
            goto L_0x0133
        ...
        L_0x00fc:
            ...
            r0.showErrConf(r1)
        L_0x012b:
            it.tecnosystemi.TS.Activity.VMC.Config.ConfigVMCActivity$4 r1 = new it.tecnosystemi.TS.Activity.VMC.Config.ConfigVMCActivity$4
            r1.<init>()
            r0.runOnUiThread(r1)
        L_0x0133:
        ...
        L_0x0136:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: it.tecnosystemi.TS.Activity.VMC.Config.ConfigVMCActivity.CheckInfoVMC(int, int, int, long):void");
    }

    private void checkVMCOnline() {
        showProgress();
        int i = this.times;
        if (i > 0) {
            this.times = i - 1;
                ...
                public void run() {
                    new Handler().postDelayed(new Runnable() {
                        public void run() {
                            ...
                            device_OP.setPIN(ConfigVMCActivity.this.pin);
                            device_OP.setSerial(ConfigVMCActivity.this.serialToCheck);
                            device_OP.setPlantId(TSDeviceListActivity.idSelected);
                            device_OP.setToken(ConfigVMCActivity.this.activity.FirebaseToken);
                            ...
                            Gson gson = new Gson();
                            new ThreadWebService(ConfigVMCActivity.this.activity, 1, 29, ConfigVMCActivity.this.getResources().getString(R.string.uriWebService) + ConfigVMCActivity.this.getResources().getString(R.string.uri_AddUserToDeviceV2), gson.toJson((Object) device_OP), (String[]) null).start();
                        }
                    }, 5000);
                }
            });
        ...
        if (response != null) {
            try {
                if (response.getHttpResponceCode() == 200 && new JSONObject(response.getHttpResponcePayload()).getInt("ResCode") == 0) {
                    addVMC(this.serialToCheck, false);
                    return;
                }
            } catch (Exception unused) {
            }
    ...
    public void addVMC(String str, boolean z) {
        Device device = new Device();
        device.setSerial(str);
        device.setLVDV_Type(Constants.DEVICE_TYPE_VMC);
        VMC.deleteVMCfromPref(str, this.activity);
        VMC.saveVMCInPref(this.name, str, this.pin, "", this.activity, z, true);
        addDevToPlant(str);
        hideProgress();
        this.activity.runOnUiThread(new Runnable() {
            public void run() {
                ConfigVMCActivity.this.enableView();
                ConfigVMCActivity.this.lblDesrc.setText(ConfigVMCActivity.this.getResources().getString(R.string.c5_deviceAdd));
                ConfigVMCActivity.this.lblDesrc.setTextColor(-1);
            }
        });
    }
    ...
    private void addDevToPlant(java.lang.String r7) {
        ...
        L_0x00a3:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: it.tecnosystemi.TS.Activity.VMC.Config.ConfigVMCActivity.addDevToPlant(java.lang.String):void");
    }

    /* access modifiers changed from: private */
    public boolean setVMCWiFiMode(int i) {
        try {
            CmdPICO.VmcAP vmcAP = new CmdPICO.VmcAP();
            vmcAP.setAp_m(i);
            vmcAP.setPin(this.pin);
            String sendCMD = UDPSocket.sendCMD(vmcAP);
            UDPSocket.stopListening();
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                ...
                AnonymousClass2 r6 = new Runnable() {
                    public void run() {
                        ConfigVMCActivity.this.dismissdialog();
                    }
                };
                ConfigVMCActivity configVMCActivity = ConfigVMCActivity.this;
                ConfigVMCActivity.this.openDialogFragment(configVMCActivity.createYesNoPopUp("", str, "", configVMCActivity.getResources().getString(R.string.general_OK), r5, r6));
            }
        });
    }
    ...
    public void error() {
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                Functions.makeErrorToast(ConfigVMCActivity.this.activity, ConfigVMCActivity.this.getResources().getString(R.string.c5_lblConfigKo));
                ConfigVMCActivity.this.lblDesrc.setText(ConfigVMCActivity.this.getResources().getString(R.string.c5_lblConfigKo));
                ConfigVMCActivity.this.lblDesrc.setTextColor(ConfigVMCActivity.this.getResources().getColor(R.color.colorerror));
                ConfigVMCActivity.this.enableView();
            }
        });
    }
