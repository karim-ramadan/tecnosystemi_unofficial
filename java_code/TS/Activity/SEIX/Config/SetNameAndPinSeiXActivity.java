...
public class SetNameAndPinSeiXActivity extends BaseActivity {
    ...
    public void onCreate(Bundle bundle) {
        setContentView(R.layout.activity_set_name_and_pin_seix_activity);
            ...
            if (i == 2 || i == 4) {
                if (Constants.ISDEMO) {
                    ...
                    AnonymousClass1 r2 = new Runnable() {
                        public void run() {
                            SetNameAndPinSeiXActivity.this.activity.runOnUiThread(new Runnable() {
                                public void run() {
                                    SetNameAndPinSeiXActivity.this.checkpin();
                                }
                            });
                        }
                    };
                    toConnPwd = "TS_" + this.serial;
                    toConnSid = Constants.WIFI_NAME_OFFLINE_6X + this.serial;
                    connectToWifi(r2, new Runnable() {
                        public void run() {
                            SetNameAndPinSeiXActivity.this.runOnUiThread(new Runnable() {
                                public void run() {
                                    String str = ((SetNameAndPinSeiXActivity.this.getResources().getString(R.string.ba_apAssente) + "\n" + SetNameAndPinSeiXActivity.this.getResources().getString(R.string.connectToPolaris)) + "\nSSID: " + BaseActivity.toConnSid) + "\n" + SetNameAndPinSeiXActivity.this.getResources().getString(R.string.c4_PwdHint) + ": " + BaseActivity.toConnPwd;
                                    AlertDialog.Builder builder = new AlertDialog.Builder(SetNameAndPinSeiXActivity.this.activity);
                                    builder.setMessage(str).setCancelable(false).setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            ...
                                            try {
                                                ...
                                                SetNameAndPinSeiXActivity.this.activity.startActivity(intent);
                                            } catch (Exception unused) {
                                            }
                                        }
                                    });
                ...
                Intent intent2 = new Intent(this, ConfigSeiXActivity.class);
                ...
                Intent intent3 = new Intent(this, ChooseWifiSeiXActivity.class);
    ...
    public void checkpin() {
        new Thread(new Runnable() {
            public void run() {
                ...
                cmdPICO.setPin(SetNameAndPinSeiXActivity.this.pin);
                    ...
                    try {
                        ...
                        if (jSONObject.has(Constants.JSON_RES)) {
                            if (jSONObject.getInt(Constants.JSON_RES) == 1) {
                                SeiX.save6XInPref(SetNameAndPinSeiXActivity.this.txtNome2.getText().toString(), SetNameAndPinSeiXActivity.this.serial, SetNameAndPinSeiXActivity.this.pin, "", SetNameAndPinSeiXActivity.this.activity, true, true);
                                SetNameAndPinSeiXActivity setNameAndPinSeiXActivity = SetNameAndPinSeiXActivity.this;
                                setNameAndPinSeiXActivity.addDevToPlant(setNameAndPinSeiXActivity.serial, SetNameAndPinSeiXActivity.this.txtNome2.getText().toString());
                                SetNameAndPinSeiXActivity.this.activity.runOnUiThread(new Runnable() {
                                    public void run() {
                                        Intent intent = new Intent(SetNameAndPinSeiXActivity.this.activity, TSDeviceListActivity.class);
                                        intent.addFlags(67108864);
                                        SetNameAndPinSeiXActivity.this.activity.startActivity(intent);
                                    }
                                });
                                ...
                                SetNameAndPinSeiXActivity.this.activity.runOnUiThread(new Runnable() {
                                    public void run() {
                                        Functions.makeErrorToast(SetNameAndPinSeiXActivity.this.activity, SetNameAndPinSeiXActivity.this.getResources().getString(R.string.au_errorAddUser));
                                    }
                                });
                            }
                        }
                        ...
                        SetNameAndPinSeiXActivity.this.activity.runOnUiThread(new Runnable() {
                            public void run() {
                                Functions.makeErrorToast(SetNameAndPinSeiXActivity.this.activity, SetNameAndPinSeiXActivity.this.getResources().getString(R.string.msg_commandKo));
                            }
                        });
                    }
                } else {
                ...
                SetNameAndPinSeiXActivity.this.hideProgress();
            }
        }).start();
    }

    public void savserver6X() {
        SeiX.save6XInPref(this.txtNome2.getText().toString(), this.serial, this.pin, "", this.activity, false, true);
    ...
    public void addDevToPlant(java.lang.String r7, java.lang.String r8) {
        ...
        L_0x009f:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: it.tecnosystemi.TS.Activity.SEIX.Config.SetNameAndPinSeiXActivity.addDevToPlant(java.lang.String, java.lang.String):void");
    }
