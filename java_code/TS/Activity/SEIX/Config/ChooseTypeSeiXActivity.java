...
public class ChooseTypeSeiXActivity extends BaseActivity {
    Button btnProc;
    TextView lbldesrc;
    TextView lblmode1;
    TextView lblmode2;
    ...
    public void onCreate(Bundle bundle) {
        setContentView(R.layout.activity_choose_type_seix_activity);
    ...
    public void btnProc(View view) {
        ...
        if (i == 2 || i == 4) {
            intent = new Intent(this, SetNameAndPinSeiXActivity.class);
        } else {
            intent = new Intent(this, EnableWifiSeiXActivity.class);
        }
