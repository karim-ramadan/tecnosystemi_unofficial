...
public class SpinnerCUIconsAdapter extends ArrayAdapter<String> {
    ...
    public SpinnerCUIconsAdapter(Context context2, List<String> list) {
        super(context2, R.layout.riga_cuicon, list);
        this.context = context2;
    }

    public View getView(int i, View view, ViewGroup viewGroup) {
        if (view == null) {
            view = LayoutInflater.from(getContext()).inflate(R.layout.riga_cuicon, (ViewGroup) null);
        }
